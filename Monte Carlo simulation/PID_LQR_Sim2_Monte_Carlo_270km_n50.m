...
n = 50; % number of simulation, take around 12 minutes for n=10
...
%     orbit.a = 6678 + rand*200;     %semimajor axis [km]
    ...
    orbit.a = 6378+270; %semi-marjor axis km
...
save('PID_Monte_Carlo_Sim2_Thrust_activation_270km_Norbit6_n50.mat');
...
%%Monte Carlo simulation
n = 50; % number of simulation, it take between 95 and 120 minutes for n=100
...
save('LQR_Monte_Carlo_Sim2_Thrust_activation_270km_Norbit6_n50.mat');