...
att.alpha = 10;         %Initial orientation Yaw [deg]
att.beta = 10;         %Initial orientation Pitch [deg]
att.gamma = 10;         %Initial orientation Roll [deg]
%Initial angular velocities in each axis (x,y,z) of body frame [degrees/sec]
att.wx0 = -0.1;        
att.wy0 = 0.1;
att.wz0 = 0.1;
...
sat.inertia = [0.196   0   0;...   %already saved
                0   0.196  0;...
                0     0   0.268];
...
%load('LOAS.mat')`
load('IonSat_6U_alt.mat');
SNAP_aeromodel=SNAP_aeromodel_alt;
...
sat.thruster.point=[-x_force_thruster;y_force_thruster;z_force_thruster]/1e3;    
                            ...
                            %Thruster located in back side of S/C
