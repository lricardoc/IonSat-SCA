%% PID SIM1 : Robustness to the inertia varation
%% UKF
clear all
close all
clc
...
K = [0.00053417  0  0  0.0070506  0  0;
    ...
    0  0  0.0008135  0  0  0.010476]; %q=0.004 r=4000
...
%     Orbit_altitude(i) = orbit.a - 6378;
    ...
    % run the simulink 
    simResults = sim('IonSatSimulationF.slx');
...
save('PID_UKF_scenario1_inertia_pm10_n100.mat');
...
save('PID_MEKF_scenario1_inertia_pm10_n100.mat');